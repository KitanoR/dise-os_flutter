      ...
      child: Container(
        child: Column(
          children: <Widget>[
            SafeArea(
              child: Container(
                ...
                child: CircleAvatar(
                  ...
                  child: Text('CK', style: TextStyle(fontSize: 50),),
                ),
              ),
            ),
            Expanded(
            ...
            ListTile(
              leading: Icon(Icons.lightbulb_outline, color: currentTheme.accentColor,),
            ...
            SafeArea(
              ...
              left: false,
                child: ListTile(
                leading: Icon(Icons.add_to_home_screen, color: currentTheme.accentColor,),
